...
func TestSearchOptionsExposeModeAwareFields(t *testing.T) {
	opt := SearchOptions{Mode: "movie-search", Season: "1", Episode: "2", IMDBID: "tt1", TMDBID: "tm1", TVDBID: "tv1", DoubanID: "db1", TVMazeID: "mz1", Artist: "art", Album: "alb", Author: "auth", Title: "ttl", Genre: "gen", Year: "2024", Categories: []string{"5000"}}
